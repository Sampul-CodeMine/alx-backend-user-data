#!/usr/bin/env python3
"""A simple end-to-end integration test for `app.py`.
"""
import requests
...
def register_user(email: str, password: str) -> None:
    """This is a test for registering a user."""
    url = f"{API_URI}/users"
    body = {
        'email': email,
        'password': password,
